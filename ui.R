...
tabPanel("Home",
         ...
         fluidRow(
           ...
           column(4, offset=1, align='center',
            ...
            HTML('<iframe width="560" height="315" src="https://www.youtube.com/embed/tcban07zOiw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>'))
           ),
         br(),
